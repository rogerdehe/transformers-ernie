...
from transformers.models.bert.modeling_bert import BertEncoder, BertPooler, BertLayer, BertPreTrainingHeads, BertOnlyMLMHead, BertOnlyNSPHead
...
class ErnieForPreTrainingOutput(ModelOutput):
    """
    Output type of :class:`~transformers.ErnieForPreTraining`.
...
ERNIE_START_DOCSTRING = r"""
    ...
    Parameters:
        config (:class:`~transformers.ErnieConfig`): Model configuration class with all the parameters of the model.
...
class ErnieLMHeadModel(ErniePreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from transformers import ErnieTokenizer, ErnieLMHeadModel, ErnieConfig
            >>> import torch

            >>> tokenizer = ErnieTokenizer.from_pretrained('ernie-1.0')
            >>> config = ErnieConfig.from_pretrained("ernie-1.0")
    ...
    def forward(
        ...
        **kwargs,
        ...
        Example::
            ...
            >>> from transformers import ErnieTokenizer, ErnieForNextSentencePrediction
            >>> import torch

            >>> tokenizer = ErnieTokenizer.from_pretrained('ernie-1.0')
            >>> model = ErnieForNextSentencePrediction.from_pretrained('ernie-1.0')
